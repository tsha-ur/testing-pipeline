...
@Component({
    templateUrl: './my_urcap_id-smartskill.component.html',
    styleUrls: ['./my_urcap_id-smartskill.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    standalone: false
})
export class My_urcap_idSmartskillComponent implements SmartSkillPresenter, OnChanges {
    @Input()
