...
@Component({
    templateUrl: './my-urcap-id-prg.component.html',
    styleUrls: ['./my-urcap-id-prg.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    standalone: false
})

export class MyUrcapIdPrgComponent implements OnChanges, ProgramPresenter {
    ...
    @Input() contributedNode: MyUrcapIdPrgNode;
